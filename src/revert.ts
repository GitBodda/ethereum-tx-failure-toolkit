...
export function findRevertData(obj: any): string | undefined {
...
export function decodeRevertData(data: string): { category: string, message: string, revertSelector?: string } {
